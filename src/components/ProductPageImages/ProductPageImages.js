...
import { addProductImage, removeProductImage } from "~/actions/product.actions"
...
function ProductPageImages() {
    ...
    const handleDeleteImage = () => {
        dispatch(removeProductImage(currImageId))
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex mt-3 gap-3">
                            <input
                                ...
                                className='sm:flex-1 border border-gray-bg rounded p-2 outline-none'
                            />
                            {imageUrl && validUrl
                                ?
