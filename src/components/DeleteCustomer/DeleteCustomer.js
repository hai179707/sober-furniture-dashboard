                    ...
                    >
                        <div className="w-1/3">
                            <Card>
                                ...
                                <CardBody>
                                    <div className="my-3">Are you sure you want to delete this customer?</div>
                                    <div className="flex justify-end gap-5 mt-5">
                                        <button className="py-2 px-4 bg-secondary-bg rounded font-semibold" onClick={() => dispatch(deleteCustomer(customer._id))}>Confirm</button>
